...
anne = User.new(name: "Anne de Joly", email: "anne@email.com", password: "123456", description: "Hi girls, I am a teacher at Le Wagon. I sometimes have classes in the evening so have to walk home quite late. I would love to have a buddy to share the walk with me as it could be scary at times walking in Shoreditch High Street", emergency_contact_name: "Ife", emergency_contact_number: "44783400327", address: "56 Shoreditch High Street, London")
...
charlotte = User.new(name: "Charlotte Jacobs", email: "charlotte@email.com", password: "123456", description: "Hi girls, I am a TV producer and my shoots often run on late. Sometimes this is after public transport timetable and I'd feel more comfortable having someone to walk back with.", emergency_contact_name: "David", emergency_contact_number: "44783400327")
...
cora = User.new(name: "Cora Bates", email: "cora@email.com", password: "123456", description: "I am an educational psychologist and work at schools. I need to walk 25 mins to the nearest station for my commute and I would prefer to share the journey with someone.", emergency_contact_name: "Jack", emergency_contact_number: "44783400327")
...
stephanie = User.new(name: "Stephanie Leftwoman", email: "stephanie@email.com", password: "123456", description: "I volunteer on Thursday nights and the roads aren't well lit. I'd feel safer if I could walk with someone for part of my journey!", emergency_contact_name: "Ron", emergency_contact_number: "44783400327")
...
issy = User.new(name: "Issy Jordan", email: "issy@email.com", password: "123456", description: "I like to go out on Saturday nights and don't always have the money to pay for an Uber so I like to walk. But I have had some bad experiences when walking alone and would prefer a buddy to help me feel safe.", emergency_contact_name: "Charlie", emergency_contact_number: "44783400327")
...
beth = User.new(name: "Beth Kodjer", email: "beth@email.com", password: "123456", description: "I have just changed job and work as a civil servant. I am still getting used to my commute and the local area so I'd like to use Flock to meet people and to help me find my way.", emergency_contact_name: "Ben", emergency_contact_number: "44783400327")
